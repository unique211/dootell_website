                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item <?php if($count==0){ echo ' active' ;}?>">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3"><a
                                    href="{{ url('student_details') }}/{{ $value['id'] }}">
                                    @if ($value['profile_photo']==null)
                                    <img src="{{ URL::asset('/resources/dist/img/how-work3.png')}}" class="center"
                                    ...
                                    <img src="{{ env('APP_URL') }}/dootell/uploads/Jobseeker/profile/{{ $value['profile_photo'] }}"
                                        style="height: 160px; width: 160px;" width="150px" class="center" height="150px"
                                        alt="">
                                    @endif</a>
                ...
                <table class="table">
                    ...
                    <tr class="odd wow fadeInUp" data-wow-delay="1s">
                        <td class="tbl-logo">
                            ...
                            @else
                            <img src="{{ env('APP_URL') }}/dootell/uploads/Company/logo/{{ $value->logo }}" width="70px"
                                height="70px" alt="">
                            @endif
